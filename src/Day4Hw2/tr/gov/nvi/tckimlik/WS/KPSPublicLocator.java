...
package Day4Hw2.tr.gov.nvi.tckimlik.WS;

public class KPSPublicLocator extends org.apache.axis.client.Service implements Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublic {
    ...
    public Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub _stub = new Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub _stub = new Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
