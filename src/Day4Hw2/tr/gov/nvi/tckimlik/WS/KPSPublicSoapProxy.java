...
public class KPSPublicSoapProxy implements Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  private String _endpoint = null;
  private Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public Day4Hw2.tr.gov.nvi.tckimlik.WS.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
